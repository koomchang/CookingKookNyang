...
public class OptionsUI : MonoBehaviour {
	...
	private void Awake() {
		...
		moveUpBotton.onClick.AddListener(() => { RebindBinding(GameInput.Binding.Move_Up); });
		moveDownBotton.onClick.AddListener(() => { RebindBinding(GameInput.Binding.Move_Down); });
		moveLeftBotton.onClick.AddListener(() => { RebindBinding(GameInput.Binding.Move_Left); });
		moveRightBotton.onClick.AddListener(() => { RebindBinding(GameInput.Binding.Move_Right); });
